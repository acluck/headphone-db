...
<body>
    ...
    <div class="graphSide">
		...
		<p><span>
    		...
    		&nbsp; ( <input type="text" class="smartInput" id="customAmount" value=0
    		style="text-align: center" onclick="updateAmountSelect()" onblur="ensureNumber(this)"> dB )
    	</span></p>
	...
	<div class="results">
	    ...
	    <div class="result-options">
			...
			<h2><span>
			Number <br> of results:
			<input type="text" class="resultInput" id="returnAmt" value=5 onblur="ensureNumber(this)">
			</span></h2>
	        <br><br>
